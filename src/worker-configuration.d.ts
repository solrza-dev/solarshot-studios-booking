/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: f2d780c8233b53841fd5d318e8b6540d)
...
interface __BaseEnv_Env {
	...
	TURNSTILE_SITEKEY: "0x4AAAAAAENnkbBy0KGKWcVQ";
	CALCOM_API_KEY: string;
	RATE_LIMIT_SHARD_KEY: string;
	TURNSTILE_SECRET: string;
	BOOKING_REQUEST_LIMITER: DurableObjectNamespace<import("./index").BookingRequestLimiter>;
	CAL_API_BUDGET: DurableObjectNamespace<import("./index").CalApiBudget>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "BookingRequestLimiter" | "CalApiBudget";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "TURNSTILE_HOSTNAMES" | "TURNSTILE_SITEKEY" | "CALCOM_API_KEY" | "RATE_LIMIT_SHARD_KEY" | "TURNSTILE_SECRET">> {}
}
